...
console.log(`     
                      𝙳𝙴𝙼𝙾𝙽Tools v1
  ____  _             Owner: 𝙱𝙻𝚄𝙴 𝙳𝙴𝙼𝙾𝙽
 | __ )| |_   _  ___  Premium: true   
 |  _ \| | | | |/ _ \ Telegram: @blue_demon
 | |_) | | |_| |  __/ WhatsApp: 2347041039367
 |____/|_|\__,_|\___| Portable Tools DDoS By 𝙱𝙻𝚄𝙴 𝙳𝙴𝙼𝙾𝙽MD
========================================================================`)}
// [========================================] //
...
async function bootup() {
  try {
    ...
    console.log(`|| ▓▓▓▓▓▓░░░░ || 60%`);
        ...
        await sleep(700)
        console.clear()
        console.log(`Welcome To 𝙱𝙻𝚄𝙴 𝙳𝙴𝙼𝙾𝙽 Tools v1`)
        await sleep(1000)
		    await banner()
